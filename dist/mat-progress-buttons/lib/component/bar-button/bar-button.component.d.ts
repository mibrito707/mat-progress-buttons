...
export declare class MatBarButtonComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MatBarButtonComponent, "mat-bar-button", never, { "options": "options"; "buttonId": "buttonId"; "active": "active"; "disabled": "disabled"; }, { "btnClick": "btnClick"; }, never, never>;
}
