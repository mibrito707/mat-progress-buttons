...
export declare class MatSpinnerButtonComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MatSpinnerButtonComponent, "mat-spinner-button", never, { "options": "options"; "buttonId": "buttonId"; "active": "active"; "disabled": "disabled"; }, { "btnClick": "btnClick"; }, never, never>;
}
